...
public class LoadingView extends RelativeLayout {
	...
	public void setText(String text) {
		TextView loadingViewText = (TextView) this
				.findViewById(me.goldze.mvvmhabit.R.id.LoadingViewText);
		loadingViewText.setText(text);
	}

	// 开始动画
	public void startAnimation() {
		View loadingViewArc = this.findViewById(me.goldze.mvvmhabit.R.id.LoadingViewArc);
		if (!isStarting) {
	...
	public void stopAnimation() {
		if (isStarting) {
			...
			final View loadingViewArc = this
					.findViewById(me.goldze.mvvmhabit.R.id.LoadingViewArc);

	...
	public ArcView(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray a = context.obtainStyledAttributes(attrs,
					me.goldze.mvvmhabit.R.styleable.ArcView);
			startAngle = a.getFloat(me.goldze.mvvmhabit.R.styleable.ArcView_arcStartAngle,
					startAngle);
			endAngle = a.getFloat(me.goldze.mvvmhabit.R.styleable.ArcView_arcEndAngle, endAngle);
			borderWidth = a.getFloat(me.goldze.mvvmhabit.R.styleable.ArcView_arcBorderWidth,
					borderWidth);
			borderColor = a.getColor(me.goldze.mvvmhabit.R.styleable.ArcView_arcBorderColor,
					borderColor);
		}
	}

...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseActivity {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if ( (binding.getRoot()).findViewById(me.goldze.mvvmhabit.R.id.LoadingView) != null) {
            loadingView = (LoadingView)  (binding.getRoot()).findViewById(me.goldze.mvvmhabit.R.id.LoadingView);
